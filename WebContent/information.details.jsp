...
<html>
  <head>
    ...
    <title><spring:message  code='咨讯信息详情'/></title>
...
$(document).ready(function(){
  ...
  //头标签效果显示 结束
    ...
    <style type="text/css">
      .info_details_title{height: 50px;border-bottom: 1px dashed #ccc;}
      .info_details_title h2{font-size: 26px;font-weight: 700;padding-bottom: 30px;margin-top: 20px;}
      .info_details_content{background:#fff;height:auto;width:100%;margin-top: 30px;padding-bottom: 80px;}
      .info_details_content h1{font-size: 28px;padding-top: 70px;padding-bottom: 45px;}
      .info_details_content img{width:1000px;height:180px;display: block;margin:0 auto;border-radius: 13px;}
      .info_details_content .details_text{padding:0 100px;margin-top: 30px;}
      .info_details_content .eidtor{text-align: right;padding-right: 80px;margin-top: 30px;}
    </style>
  </head>
...
<nav class="search_nav">
      ...
      <div class="info_details">
        <div class="info_details_title">
          <h2><spring:message  code='资讯信息详情'/></h2>
        </div>
        <div class="info_details_content">
          <h1 class="text-center">${article.title }</h1>
          <!-- <img src="http://via.placeholder.com/1000x300" alt=""> -->
          <div class="details_text">
            <p>
              ${article.context }
            </p>
            <div class="eidtor">
              <p><spring:message  code='作者'/>：<span>${article.auther }</span></p>
              <p>${article.issueDate }</p>
            </div>
          </div>
        </div>
      </div>

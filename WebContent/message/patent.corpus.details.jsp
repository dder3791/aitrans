...
<html>
  <head>
    ...
    <title><spring:message  code='语料详情'/></title>
 ...
 <script type="text/javascript" src="${pageContext.request.contextPath}/layui/lay/dest/layui.all.js"></script>
	...
	<script type="text/javascript">
		$(function(){
			...
			var corpusOrigin ="${corpus.corpusOrigin }";
			var corpusTarget = "${corpus.corpusTarget }";
			var msg = "${msg }"
			if(msg!=null && msg!="" && msg!=undefined){
				var str1 = corpusOrigin.substring(0, corpusOrigin.indexOf(msg));
				var str2 = corpusOrigin.substring((corpusOrigin.indexOf(msg)+msg.length),corpusOrigin.length)
				corpusOrigin =str1+"<font color=red>"+msg+"</font>"+str2;
			}
			$("#corpusOrigin").append(corpusOrigin);
			$("#corpusTarget").append(corpusTarget);
		});
		//头标签效果显示  开始
    ...
    <style media="screen">
    .patent_knowledge_title{height: 50px;border-bottom: 1px dashed #ccc;}
    .patent_knowledge_title h2{font-size: 26px;font-weight: 700;padding-bottom: 30px;margin-top: 20px;}
    .patent_knowledge_content{background:#fff;height:auto;width:100%;margin-top: 50px;padding:40px 30px 80px 30px;}
    .patent_knowledge_content .patent_lng{width:80%;min-height:400px;background: #f1f1f1;padding:20px 40px;border-radius: 13px;margin-left: 10%;margin-top: 20px;margin-bottom: 70px;}
    .patent_knowledge_content .patent_lng p{font-size: 18px;}
    </style>
...
<nav class="search_nav">
      ...
      <!-- 术语详情 -->
      <div class="patent_knowledge_details">
        <div class="patent_knowledge_title">
          <h2><spring:message  code='语料详情'/></h2>
        </div>
        <div class="patent_knowledge_content">
          <div class="row">
            <div class="col-sm-6">
              <h4><spring:message  code='语料原文：'/></h4><br>
              <div class="patent_lng">
                <p id ="corpusOrigin"></p>
              </div>
            </div>
            <div class="col-sm-6">
              <h4><spring:message  code='语料译文：'/></h4><br>
              <div class="patent_lng">
                <p id="corpusTarget"></p>
              </div>
            </div>

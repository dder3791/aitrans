		...
		$("#button").click(function(){
            ...
            $.post("/translator/translatorAction_queryByAll.do","pageNum="+1+"&domains="+domains+"&language="+languages+"&msg="+msgs+"&levels="+levels+"&degree="+degree,function(data){
			  ...
			  var domains=data.domainList; 
          	  var trans=data.translatorList;
          	  var translevel=data.translatorLevel;
          	 var cards_one = "<div class='append_card' ><div style='border-radius:10px;' class='cards_one text-right fl' style='height:300px'><img class='card_img' id='transPhoto'  src='/img/tuxiang.jpg ' alt='' width='80' height='90'><p style='width:195px;margin-left:20px;text-align: left;'><span class='card_name' id='nickname'></span></p><p hidden=''><span id='transId'></span></p><p><span id='level' ></span></p><p><span id='languages'></span></p><p><spring:message  code='学历：'/><span id='degree'></span></p><div class='texts_left'><p><span></span></p><p style='padding-top:20px'><spring:message  code='专业领域：'/><span id='trandomain'></span></p><p id='checkTransT'><spring:message  code='翻译经验：'/><span id='tranTotals'></span></p><p id='checkProoT'><spring:message  code='校对经验：'/><span id='prooTotals'></span></p></div><div class='append_card_btn'><a href='' class='append_card_btn01' id='checkTrans'><spring:message  code='选'/>TA</a><a href='' target='_blank'  class='append_card_btn02' id='lookTrans' ><spring:message  code='详情'/></a></div></div></div>";	 
             //二次点击删除之前卡片信息
          	 $(".append_card").remove();
             for(var i=0;i<trans.length;i++){
               $(".index_linguister_card").append(cards_one);
      ...
      <div class="interpreter_conts" align="center">
        ...
        <div class="interpreter_search">
          <form class="form-inline">
            <div class="form-group">
              <select class="form-control select_wid" name="" id="domain">
                ...
                <option value="通信"><spring:message  code="通信"/></option>
            ...
            <div class="form-group">
              <select class="form-control level" name="" id="level">
                <option value=""><spring:message  code="等级"/></option>
              </select>
            </div>
            
             <div class="form-group">
              <select class="form-control degree" name="" id="degree">
                <option value=""><spring:message  code="学历"/></option>
          ...
          <!-- <div class="checks_langu row">
            <span class="col-sm-1">选择语种：</span>
            <div class="col-sm-10">
             <label class="checkbox-inline"> <input type="radio"
						name="language" value="EN" checked="checked"> 汉译英
					</label> <label class="checkbox-inline"> <input type="radio"
						name="language" value="EN"> 英译汉
					</label> <label class="checkbox-inline"> <input type="radio"
						name="language" value="JP"> 日译汉
					</label> <label class="checkbox-inline"> <input type="radio"
						name="language" value="JP"> 汉译日
					</label> <label class="checkbox-inline"> <input type="radio"
						name="language" value="KOR"> 韩译汉
					</label> <label class="checkbox-inline"> <input type="radio"
						name="language" value="KOR"> 汉译韩
					</label> <label class="checkbox-inline"> <input type="radio"
						name="language" value="FR"> 法译汉
					</label> <label class="checkbox-inline"> <input type="radio"
						name="language" value="FR"> 汉译法
					</label>
					
			   <div class="checbox_all">
						<label class="checkbox-inline"> <input type="radio"
							name="language" value="GER"> 德译汉
						</label> <label class="checkbox-inline"> <input type="radio"
							name="language" value="GER"> 汉译德
						</label>
					</div>		
              <span class="checkbox-inline checkbox_click">展示更多 <i class="fa fa-angle-double-right" aria-hidden="true"></i></span>
            </div>
          </div> -->
        </div>

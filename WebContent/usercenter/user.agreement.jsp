...
<html>
  <head>
    ...
    <title><spring:message  code='用户中心-我是用户-用户协议'/></title>
    ...
    <style type="text/css">
     ...
     $(function(){
    	/*  $.post("/agreetment/queryByAllagreetment.do?agreetment=用户",function(data){
            ...
            <div class="my_customer_right col-sm-10">
              ...
              <!--  用户中心右侧 tab切换栏   -->
                ...
                <div class="myTabContent tab-content">
                    ...
                    <h3 class="text-center" id="deal"><spring:message  code='客户协议'/></h3>
                      &nbsp;&nbsp;&nbsp;&nbsp;环宇爱译以下简称（爱译）”在此特别提醒您（用户）在注册成为用户之前，请认真阅读本《用户协议》（以下简称“本协议”），确保您充分理解本协议中各条款。请您审慎阅读并选择接受或不接受本协议。除非您接受本协议所有条款，否则您无权注册、登录或使用本协议所涉服务。
  您的注册、登录、使用等行为将视为对本协议的接受，并同意接受本协议各项条款的约束。
  本协议约定“爱译”与用户之间关于“语言服务”的权利义务。“用户”是指注册、登录、使用“爱译”提供的语言服务的公司或个人。本协议可由“爱译”随时更新，更新后的协议条款一旦公布即代替原来的协议条款，用户可在本网站查阅最新版协议条款。在“爱译”修改协议条款后，如果用户不接受修改后的条款，请立即停止使用“爱译”提供的服务，若用户继续使用“爱译”提供的服务将被视为接受修改后的协议。

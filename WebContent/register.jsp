...
//--------------------------------赵磊结束----------------------------------------------------------------------------------------------------------------
    		...
    		if($("#tel").val() == ""){
    			...
    			return false;
   			    ...
   			    /*  $('#userMes').html("<font color='#FF8800'><b>×<spring:message  code='手机号格式错误'/></b></font>"); */
   			    	...
   			    	$.post("/ClientUser/clientUserAction_checkUsername.do","tel="+tel,function(data){
      			    	 if(data ==0){
    ...
    function sendMessage(){
    	  var phone=$("#tel").val();
    	$.post("/ClientUser/clientUserAction_checkUsername.do","tel="+phone,function(data){
       	 if(data ==0){
    ...
    <div class="container-fluid" style="padding:0;">
      ...
      <div class="register_top container">
        <div class="row">
          ...
          <h1 class="login_register col-sm-8"><spring:message  code='欢迎注册'/></h1>
        </div>
      </div>
      <!--------  login body  -------->
      <div class="" style="background:#8db5e3;background: url('${pageContext.request.contextPath}/img/login273.jpg') center no-repeat;background-size: 100% 100%"> 
        <div class="register_body regContainer">
          <div class="row">
            ...
            <div class="register_body_right pull-right" style="margin-top:180px;height:200px;">
            	<div class="row" style="margin-top:20px;">
            		<label class="col-xs-12" style="line-height: 36px;text-align: center;color:#fff;font-size: 18px;"><spring:message  code='请选择注册角色'/></label>
            	</div>
            	<div class="row" style="margin-top:10px;">
            		<div class="col-xs-2"></div>
            		<div class="col-xs-8">
            			<a href="${pageContext.request.contextPath}/forwardAction/forward_toRegisterInter.do"><button class="btn btn-info" style="width:100%;height:40px;font-size: 20px;"><spring:message  code='我要成为译员'/></button></a>
            		</div>
            		<div class="col-xs-2"></div>
            	</div>
            	<div class="row" style="margin-top:20px;">
            		<div class="col-xs-2"></div>
            		<div class="col-xs-8">
            			<a href="${pageContext.request.contextPath}/forwardAction/forward_toRegisterCustomer.do"><button class="btn btn-info" style="width:100%;height:40px;font-size: 20px;"><spring:message  code='我要成为客户'/></button></a>
            		</div>
            		<div class="col-xs-2"></div>
            	</div>
              <%-- <div class="header">
                <div class="switch" id="switch" style="top: -4px;text-align:center">
                  ...
                  <a class="switch_btn"  style="width:200px;text-align:center;color:white;" id="switch_login"  href="javascript:;"><spring:message  code='邮箱注册'/></a>
					<div class="switch_btn_focus" style="width:120px;margin-top: 4px;height:40px;margin-left: auto;margin-right: auto">
						<a class="switch_btn_focus switch_qlogin" style="width:180px;color:#000000;height:43px;" id="switch_qlogin" href="javascript:;"><strong><spring:message  code='客户'/></strong></a>
					</div>
				  	<div class="switch_btn" style="margin-left:55px">
				  		<a class="switch_btn" style="width:180px;text-align:center;color:black;height: 43px" id="switch_login"  href="javascript:;"><strong><spring:message  code='译员'/></strong></a>
				  	</div>
                    ...
                    <form name="loginform" id="login_form" class="loginForm form-horizontal" action="${pageContext.request.contextPath}/ClientUser/clientUserAction_saveUser.do"  method="post"><input type="hidden" name="did" value="0"/>
                      ...
                      <div class="login_radio"  id="inlineRadio">
                        ...
                        <label class="radio-inline">
                          ...
                          <input type="radio" class="login_radio" name="radioValue" id="inlineRadio1" onclick="radioss(this)" value="我是译员" ><font style="color:white;"><spring:message  code='我是译员'/></font>
              ...
              <%-- <div class="qlogin" id="qlogin" style="display: none; " id="fastRegister">
                <div class="web_login">
                  <div id="userCue" style="color:white;" class="cue"><spring:message  code='快速注册请注意格式'/></div>
                    <!-- 译员注册表单开始 -->
                   	<form name="loginform" id="login_form" class="loginForm form-horizontal" action="${pageContext.request.contextPath}/ClientUser/clientUserAction_saveUser.do?radioValue='我是译员'"  method="post"><input type="hidden" name="did" value="0"/>
                       <div class="form-group row">
                        <label for="tel" style="color:white;" class="col-xs-2 control-label"><spring:message  code='手机号'/></label>
                        <div class="col-xs-8">
                          <input type="text" class="form-control" id="tel" onblur="checkPhone()" placeholder="<spring:message  code='请输入手机号'/>" name="cellphone"><!-- onblur="checkPhone()" -->
                    ...
                    <%-- <form name="form2" class="form-horizontal" id="regUser" accept-charset="utf-8"  action="${pageContext.request.contextPath}/ClientUser/clientUserAction_saveUser.do" method="post">
                      ...
                      <div class="login_radio" id="inlineRadio" >
                        ...
                        <label class="radio-inline02" style="padding-left:20px;">
                          <input type="radio" name="radioValue" class="login_radio02" id="inlineRadio3" onclick="radiosss(this)" value="我是译员"  ><font style="color:white;"><spring:message  code='我是译员'/></font>
                        </label>
                        <label class="radio-inline02">

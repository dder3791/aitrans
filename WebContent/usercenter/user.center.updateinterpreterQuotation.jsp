            ...
            <div class="my_customer_right col-sm-10">
              ...
              <div class="">
                <ul id="suerTab" class="nav nav-tabs">
                 <li class="active"><a href="#personals" data-toggle="tab"><spring:message  code='基本资料'/></a></li>
                 <li><a id="trans" href="#transMessages" data-toggle="tab"><spring:message  code='翻译信息'/></a></li>
                ...
                <div class="myTabContent tab-content" >
                   <!-- 个人资料面板开始 -->     
                   <div class="tab-pane fade in active" id="personals"  style="padding:50px 60px 80px 40px;">
                    ...
                    <div class="basic_data">
                      ...
                      <!-- 上传头像 -->
                      <div class="file_head" style="padding-top:30px;" style="padding:50px 60px 80px 40px;">
                    ...
                    <!-- 个人资料面板结束 --> 
                  <div class="tab-pane fade" id="transMessages" >
                     <h4><spring:message  code='翻译信息'/></h4>
                      <div class="basic_data">
                        <form class="form-inline"  method="post" id="editForm" action="${pageContext.request.contextPath}/translator/translatorAction_updateTransQuotation.do"  >
                		...
                		<div class="form-group" style="width:100%">
                        	...
                        	<div class="row" style="margin-top:30px;">
              		         	...
              		         	<div class="col-xs-3">
              		         	 <input type="text" style="width:100%" class="form-control" id="tranPrice" name="tranPrice" class="tranPrice" placeholder="<spring:message  code='请输入翻译价格'/>"  value="${translatorsQ.tranPrice}" onblur="checkTranPrice(this)">
              		        	</div>
              		        	...
              		        	<div class="col-xs-3">
              		        	    <input type="text" style="width:100%" class="form-control" id="majorTotal" name="majorTotal" placeholder="<spring:message  code='请输入专业翻译字数'/>" value="${translatorsQ.majorTotal}">
              		      		</div>
                        	...
                        	<div class="row" style="margin-top:30px;">
              		         	...
              		         	<div class="col-xs-3">
              		         	<input type="text" style="width:100%" class="form-control" id="dayTrans" name="dayTrans" class="dayTrans" placeholder="<spring:message  code='请输入日翻译量'/>" value="${translatorsQ.dayTrans}">
              		        	</div>
              	        	</div>
                        	...
                        	<div class="row" style="margin-top:30px;">
              		         	...
              		         	<div class="col-xs-3">
              		         	<input type="text" style="width:100%" class="form-control" id="prooPrice" name="prooPrice" class="prooPrice" placeholder="<spring:message  code='请输入校对价格'/>"  value="${translatorsQ.prooPrice}" onblur="checkProoPrice(this)">
              		        	</div>
              		        	<label  class="col-xs-1 rowlabel" style="text-align: left;"><font color="red"><spring:message  code='(元)'/></font></label>
              		        	<label  class="col-xs-2 rowlabel"><spring:message code='校对总字数'/></label>
              		        	<div class="col-xs-3">
              		        	<input type="text"  style="width:100%" class="form-control" id="prooTotal" name="prooTotal" placeholder="<spring:message  code='请输入校对总字数'/>" value="${translatorsQ.prooTotal}">
              		      		</div>
                        	...
                        	<div class="row" style="margin-top:30px;">
              		         	...
              		         	<div class="col-xs-3">
              		         	 <input type="text" style="width:100%" class="form-control" id="dayProo" name="dayProo" class="dayProo" placeholder="<spring:message  code='请输入日校对量'/>" value="${translatorsQ.dayProo}">
              		        	</div>
              		        	<label  class="col-xs-1 rowlabel" style="text-align: left;"><font color="red"><spring:message  code='(字)'/></font></label>
              	        	</div>
              	        	</c:if>
              	        	...
              	        	<div class="row" style="margin-top:30px;">
              		         	...
              		         	<div class="col-xs-3">
              		         	 <input type="text" style="width:100%" class="form-control" id="auditPrice" name="auditPrice" class="auditPrice" placeholder="<spring:message  code='请输入审核价格'/>"  value="${translatorsQ.auditPrice }" onblur="checkAuditPrice(this)">
              		        	</div>
              		        	<label  class="col-xs-1 rowlabel" style="text-align: left;"><font color="red"><spring:message  code='(元)'/></font></label>
              		        	<label  class="col-xs-2 rowlabel"><spring:message code='审核总字数'/></label>
              		        	<div class="col-xs-3">
              		        	 <input type="text" style="width:100%" class="form-control" id="auditTotal" name="auditTotal" placeholder="<spring:message  code='请输入审核总字数'/>" value="${translatorsQ.auditTotal }">
              		      		</div>
              		      		<label  class="col-xs-1 rowlabel" style="text-align: left;"><font color="red"><spring:message  code='(万字)'/></font></label>
              	        	</div>
              	        	<div class="row" style="margin-top:30px;">
              		         	...
              		         	<div class="col-xs-3">
              		         	<input type="text" style="width:100%" class="form-control" id="dayAudit" name="dayAudit" class="dayAudit" placeholder="<spring:message  code='请输入日审核量'/>" value="${translatorsQ.dayAudit}">
              		        	</div>
              		        	<label  class="col-xs-1 rowlabel" style="text-align: left;"><font color="red"><spring:message  code='(字)'/></font></label>
              	        	</div>
                            </c:if>
                            <div class="row" style="margin-top:30px;">
               		         	<label  class="col-xs-1 rowlabel"><spring:message code='原文'/></label>
              		         	   <textarea class="form-control" id="worksOrigin" cols="10" rows="10" style="width:87%;" name="worksOrigin">${translatorsQ.worksOrigin}</textarea>
              		        	<label  class="col-xs-1 rowlabel" style="text-align: left;"></label>
              	        	</div>
              	        	<div class="row" style="margin-top:30px;">
               		         	<label  class="col-xs-1 rowlabel"><spring:message code='译文'/></label>
              		         	<textarea class="form-control" id="worksTarget" cols="10" rows="10"  style="width:87%;" name="worksTarget">${translatorsQ.worksTarget}</textarea>
              		        	<label  class="col-xs-1 rowlabel" style="text-align: left;"></label>
              	        	</div>
              	        	<div align="center">
                          <button type="submit" class="btn btn-info" name="button" id="checkPrice" onclick="return check()"><spring:message  code='保 存'/></button>
                           </div>
                        </div>
                      </form>
                    </div>

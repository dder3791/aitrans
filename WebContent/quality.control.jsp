...
<html>
  <head>
    ...
    <title><spring:message  code='质量控制'/></title>
      ...
      <div class="quality_control">
        <div class="content_public">
          ...
          <div class="title_public">
            <h2><spring:message  code='质量控制'/></h2>
          </div>
          <h3 style="padding-bottom:40px;font-size:18px;"><spring:message  code='环宇爱译全球翻译平台--质量控制措施'/></h3>
          <ul class="quality_control_list">
          
            <li>
             1、<spring:message  code='客户与平台发布需求后，在译员返稿后可以对文件以及翻译内容进行基本内容及文件数量，如若缺少文件则可以选择拒绝签收。平台将在出现拒收的情况下扣除部分译员翻译报酬，返还给客户。'/>
            </li>
         <li>&nbsp;</li>
            <li>
            2、<spring:message  code='在客户接受后未发现问题，并已签收了稿件，对其基本翻译工作并不满意，可于订单签收后15天书写评价，平台会依据评价分数进行译员翻译报酬的扣除，并于后续返还给予客户。'/>
            </li>
           <li>&nbsp;</li>
            <li>
             3、<spring:message  code='在客户存在以上问题，同时需要解决翻译文件不达标，却已经签收的情况下，请联系平台客服，或致电010-82895385环宇爱译公司，请求平台管理员介入解决问题。'/>
            </li>
              <li>&nbsp;</li>
            <li>
          	 4、<spring:message  code='如果存在以上都不能解决的问题，还可以于平台帮助中心查看留言，寻求在线帮助等。'/>
            </li>
          </ul>
          <div>
            <img src="${pageContext.request.contextPath}/img/qualityControl.jpg" style="width:1000px;height:600px;" >
          </div>
        </div>
      </div>
      <!--  质量控制 内容结束 -->

...
<!--标注作者-->
<title><spring:message  code='平台咨讯'/></title>
<link rel="stylesheet"
...
//	        var pageCount = 1;
	...
	$(function() {
		...
		$(".news_information").click(function(){
			window.location.href="/article/articleAction_getActivityTotalCount.do";
	   });
			...
			<div class="information_select">
				<div>
					<select class="form-control" name="type">
						<option value="活动资讯"><spring:message  code='活动资讯'/></option>
						<option value="平台资讯" selected="selected"><spring:message  code='平台资讯'/></option>

...
<meta charset="utf-8">
    ...
    <title><spring:message  code='发布需求 失败'/></title>
...
<nav class="search_nav">
      ...
      <div class="publish_success">
        <div class="publish_success_top">
          ...
          <h4><spring:message  code='发布需求失败！'/></h4>
          <p><spring:message  code='失败原因：可能是由于您的网络问题，请检查您的网络'/></p>
        </div>
        <ul class="publish_success_ul list-inline">
          <li><a href=""><spring:message  code='重新发布'/></a></li>
          <li><a href="publish.need.jsp"><spring:message  code='返回'/></a></li>
          <li><a href="index.jsp"><spring:message  code='首页'/></a></li>
        </ul>
      </div>
      <!-- 需求发布失败 开始 -->
      ...
      <!--  猜你想看  开始  -->
        <div class="guess_look">
          ...
          <ul class="guess_look_ul">
            <li><a href="#"><img src="http://via.placeholder.com/210x200" alt=""></a></li>
            <li><a href="#"><img src="http://via.placeholder.com/210x200" alt=""></a></li>
            <li><a href="#"><img src="http://via.placeholder.com/210x200" alt=""></a></li>
            <li><a href="#"><img src="http://via.placeholder.com/210x200" alt=""></a></li>
            <li><a href="#"><img src="http://via.placeholder.com/210x200" alt=""></a></li>

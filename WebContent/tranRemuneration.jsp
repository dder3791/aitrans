...
<html>
  <head>
    ...
    <title><spring:message  code='稿费明细介绍'/></title>
      ...
      <div class="team_presentation">
        <div class="team_presentation_content content_public" style="margin-top:40px;">
          <div class="title_public">
            <h2 align="center"><spring:message  code='稿酬明细'/></h2>
          </div>
        
         <p>&nbsp;&nbsp;&nbsp;&nbsp;一.译员应按规定日期完成平台委托翻译之任务（有特殊情况应提前通知对方）如译员因故不能按时交稿的，应提前至少两个工作日或三天书面通知平台，若时间允许，可由双方另行约定交稿日期；若因平台稿件期限将至不能延期交稿，则平台有权终止委托，不支付译员任何费用。如因平台原因而必须中途暂停翻译，则交稿期限按照暂停时间依次后延；若因平台原因而必须终止翻译，则平台需支付译员已经完成的翻译部分的费用。<p><br>
  &nbsp;&nbsp;&nbsp;&nbsp;二.平台对在稿件翻译过程中通常会出现以下情况：翻译中存在的可译与不可译、两种语言中没有意义绝对相同的两个词、同一语言中没有意义绝对相同的词以及各语言或同一语言中表达方式的无限多样性等问题应予以理解与接受，作为翻译公司，力求避免这些偏差。但是平台不能因为对某些词的择取而拒稿或降低稿费，任何争议，双方应以商讨方式解决。
为了使译员的翻译工作更好地符合平台的翻译要求，平台可将每次翻译业务的审核意见和/或审定译文反馈给译员，译员进行相应总结。<p><br> 
 &nbsp;&nbsp;&nbsp;&nbsp; 三.如果平台对译员翻译质量有异议，平台应在收稿之日起20日内提出，译员有义务在平台书面或电子邮件通知后对译文所出现的错误进行及时免费修改。如果经译员两次修改后仍存在质量问题，平台可根据错误率及错误严重程序扣除相应翻译费用3%-30%。如果平台接到稿件后20日内没有提出任何异议，则认为平台已经认可译员之翻译质量。<p><br>
 &nbsp;&nbsp;&nbsp;&nbsp; 四.如平台所提供的原稿修改或删减，而须译员对译文作相应修改，如已翻译的文字被删减，平台也应根据字数向译员支付翻译费；如平台增加翻译内容，则按增加翻译内容另行收费。<p><br>
  &nbsp;&nbsp;&nbsp;&nbsp;五.时间要求：译员单个译员每天（8小时）平均翻译量：2000-3000字（具体的：3000字内3天，3000-10000字6天，10000-20000字9天）。译员对于特急案可以收取30％～50％加急费用。但译员需要收取加急费，需事先征得平台的书面同意，否则平台不支付加急费用。
译员每月初将上月翻译完成的稿件账单发送平台，平台收到账单和发票并确认无误后,应在当月月底之前付清稿费。（首次合作，平台应预先支付50%的翻译费）          

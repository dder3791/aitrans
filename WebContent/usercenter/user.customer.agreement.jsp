...
<html>
  <head>
    ...
    <title><spring:message code='用户中心-我是客户'/></title>
    ...
    <style type="text/css">
     ...
     $(function(){
		...
		if(lang==""){
    	 ...
    	 $.post("/agreetment/queryByAllagreetment.do?agreetment=<spring:message code='用户'/>",function(data){
    		 ...
    		 $("#deal").after("<p style='text-indent:0;'>"+jQuery.i18n.prop('userAgreement'+data[0].items)+"</p>");	
    		        }
    		 })
    	 },"json");
  ...
  <c:if test="${clientid.id==null && transid.id==null }">
    ...
    <div class="user_center">
      ...
      <div class="container"><div class="title_public">
            ...
            <div class="my_customer_right col-sm-10">
              ...
              <!--  用户中心右侧 tab切换栏   -->
                ...
                <div class="myTabContent tab-content">
                    ...
                    <h3 class="text-center" id="deal"><spring:message code='用户协议'/></h3>
                    
                    <%-- <div class="agrees_content">
                      <button type="button" class="btn btn-default" name="button"><spring:message code='同意并申请协议'/></button>
                    </div> --%>
                  </div>

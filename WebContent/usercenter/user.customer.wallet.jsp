...
<html>
  <head>
    ...
    <title><spring:message code='用户中心-我是用户-我的钱包'/></title>
            ...
            <div class="my_customer_right col-sm-10">
              ...
              <div class="">
                <ul id="suerTab" class="nav nav-tabs">
                  ...
                  <%-- <li><a href="#realname" data-toggle="tab"><spring:message code='交易信息'/></a></li> --%>
                </ul>
              </div>
                ...
                <div class="myTabContent tab-content">
                  ...
                  <div class="tab-pane fade in active" id="basicdata" style="padding:20px 20px 30px 30px;">
                    <div class="wallet_message">
                      <p style="letter-spacing:8.5px;"><spring:message code='姓名：'/><span>${clientUser.realName}</span></p>
                      <p><spring:message code='银行卡：'/><span>${clientUser.bankAccount }</span></p>
                      <p><spring:message code='开户行：'/><span>${clientUser.openingBank }</span></p>
                    </div>
                    ...
                    <div class="row wallet_money">
                      <div class="col-sm-6 money_left">
                        <p class="money_balance">
                          ...
                          <span style="font-size:18px;">${clientUser.balance}<spring:message code='元'/></span>
                        </p>
                      </div>
                      <div class="col-sm-5 money_right">
                        <p><a href="/cilentCustomer/findPayValueUI.do" target="_blank"><spring:message code='充值'/></a></p>
                    ...
                    <div class="explain">
                      <ul class="list-group" >
                        ...
                        <li>2、<spring:message code='在第三方支付并不能完成您的充值要求时，请与平台客服进行联系，来由客服辅助完成充值服务。联系电话：'/>010-82895385</li>
   ...
   <div id="gradient" class="footer_content">
    ...
    <script type="text/javascript">
      $(function(){
    	  ...
    	  $(".cus_iter_navlists:nth-child(3)").addClass('useractive');

...
<html>
  <head>
    ...
    <title><spring:message  code='认证流程'/></title>
      ...
      <div class="translation_process" style="margin-top:40px;">
        <div class="content_public">
          <div class="title_public">
            <h2><spring:message  code='认证流程'/></h2>
          </div>
          <div style="width:100%;height:2px;border:1px dashed #ccc;margin-top:20px;"></div><br><br>
          <div style="text-align:center;">
            <img  alt="" src="${pageContext.request.contextPath}/img/identification.jpg">
          </div>
        </div>
      </div>

...
<html>
  <head>
    ...
    <title><spring:message  code='译员须知'/></title>
      ...
      <div class="quality_control">
        <div class="content_public">
          ...
          <div class="title_public">
            <h2><spring:message  code='译员须知'/></h2>
          </div>
          
          <ul class="quality_control_list" style="font-size:15px;">
            <li><b>1、<spring:message  code='译员须满足平台的条件说明。'/></b></li><br>
			<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='为了使译员可以更方便的在平台上接受任务，需要在基本资料中填写详细信息，并根据自身情况上传翻译资料、校对资料以及审核资料进行后台人员审核。译员初步审核通过后就可以填写相关语言对、翻译价格信息以及原译文信息等必要的报价信息。'/></li><br>
			<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='如果译员同时兼有校对或审核的能力，可以上传相应的文件进行后台审核，审核通过可以对于之前添加的翻译报价进行详细增加修改。(例如：只上传基本个人简历，后台通过评定给予等级，再添加翻译报价只可添加关于翻译的基本相关信息。)'/></li><br>
			<li><b>2、<spring:message  code='译员可享受的服务。'/></b></li><br>
<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='译员可以在平台首页/项目展示面上查询相关招标项目并可以进行投标（注：投标时译员需要满足需求所需的翻译要求,投标采取抢单模式抢到则形成订单。）'/></li><br>
<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='译员也可以在用户中心-寻找需求中查看平台推送的需求直接进行接受。（注：接受则形成订单）'/></li><br>
<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='同时平台为译员提供在线的术语、语料查询。'/></li><br>
<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='译员也可以免费使用软件辅助翻译。'/></li><br>
<li><b>3、<spring:message  code='译员日常接受任务。'/></b></li><br>
<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='译员可以按三种模式条件进行查看与自己对应的需求并可以选择接受或不接受任务。（除主动投标模式在首页/项目展示中接受，其余任务在用户中心-->寻找需求中进行接受）。主动投标模式下译员需要根据自身条件与需求条件进行对比，符合条件方可进行投标。'/></li><br>
<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='译员接受任务进入订单模式，译员根据自身进展情况选择流程进度,通过点击确认流程完成按钮进入下一步流程中，译员可以对于当前流程状态进行获取传入不同文件文件，可以进行文件下载以及删除选择。'/></li><br>
           <li><b>4、<spring:message  code='平台给予的便利条件。'/></b></li><br>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='译员可针对自己选择可接受的项目进行主动投标。'/></li><br>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='平台针对符合译员的任务进行推送，可以直接在推送中选择自己愿意接受的任务进行接受。'/></li><br>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='平台针对译员可以提供专业的等级提升准则，更加正规的获取对应高等级的酬劳。'/></li><br>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message  code='平台给予译员免费使用爱译智能-PAT的免费使用权限。'/></li><br>
			</ul>
        </div>
      </div>
      <!--  质量控制 内容结束 -->

...
<html>
  <head>
    ...
    <title><spring:message  code='服务宗旨'/></title>
      ...
      <div class="quality_control">
        <div class="content_public">
          ...
          <div class="title_public">
            <h2><spring:message  code='服务宗旨'/></h2>
          </div>
          <h3 style="padding-bottom:40px;font-size:18px;"><spring:message  code='环宇爱译全球翻译平台--服务宗旨'/></h3>
          ...
          <div>
            <img src="img/service.aim.jpg" style="width:1000px;height:600px;" >
          </div>
        </div>
      </div>
      <!--  质量控制 内容结束 -->

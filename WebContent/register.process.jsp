...
<html>
  <head>
    ...
    <title><spring:message  code='注册流程'/></title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/translation.prceess.js"></script>
...
<nav class="search_nav">
              ...
              <a href="/cilentCustomer/publishNeed.do" class="btn btn-info requirements" id="publishNeedClick" ><spring:message  code='发布项目'/></a>
      ...
      <!--  翻译流程图  -->
      <div class="translation_process" style="margin-top:40px;">
        <div class="content_public">
          <div class="title_public">
            <h2><spring:message  code='注册流程'/></h2>
          </div>
          <div style="width:100%;height:2px;border:1px dashed #ccc;margin-top:20px;"></div>
          <br>
          <div style="text-align:center;">
            <img  alt="" src="${pageContext.request.contextPath}/img/register.jpg">

...
<!--标注作者-->
<title><spring:message  code='公告咨讯'/></title>
<link rel="stylesheet"
...
//	        var pageCount = 1;
	...
	/* 	var tnickname = "${transid.nickname}";
		...
		$(".news_information").click(function(){
			window.location.href="/article/articleAction_getNoticeTotalCount.do";
	   });
			...
			<div class="information_select">
				<div>
					<select class="form-control" name="type">
						...
						<option value="公告资讯" selected="selected"><spring:message  code='公告'/></option>
					</select>
				</div>
			</div>

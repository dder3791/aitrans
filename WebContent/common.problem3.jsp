...
//  	        var pageCount = 1;
      ...
      var GG = {
          "kk":function(mm){
        	  if(isNaN(mm)){
    	    	...
    	    	if(x!=2){
    	    	$.post("/questionAndAnswer/questionAndAnswer_queryByQuestionsandProblem3.do?pageNum="+mm+"&msg="+msg,function(data){
    	    		var oul=$(".problems_ul");
    ...
    //判断总记录数是否为0
      ...
      $("#search").click("click", function() {// 绑定查询按扭
   		msg=$("#queryByType").val();
         x = 2;
	        	$.post("/questionAndAnswer/questionAndAnswer_queryByQuestionsandProblem3.do?pageNum="+pageNum+"&msg="+msg,function(data){
	            //获取page对象
				var page = data.page;
	        	var oul=$(".problems_ul");
  	            var oli = oul[0].getElementsByTagName("li");
    ...
    <div class="container">
      ...
      <div class="common_problem">
        ...
        <%-- <div class="common_problem_content">
            <c:forEach items="${questionMap.QuestionAndAnswerList}" var="questions">
        ...
        <div class="common_problem_content">
          <div class="common_problem_text">
            ...
            <!--currentpage="1" numbercount="100"-->
          <div class="common_problem_page"><ul class="page" maxshowpageitem="3" pagelistcount="2"  id="page"></ul></div>
        </div>
      </div>
<!--  我要提问  -->

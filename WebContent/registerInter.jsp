...
//--------------------------------赵磊结束----------------------------------------------------------------------------------------------------------------
    		...
    		if($("#tel").val() == ""){
    			...
    			return false;
   			    ...
   			    /*  $('#userMes').html("<font color='#FF8800'><b>×<spring:message  code='手机号格式错误'/></b></font>"); */
   			    	...
   			    	$.post("/ClientUser/onlyTel.do",{"tel":tel,"type":"trans"},function(data){
      			    	 if(data ==0){
    ...
    function sendMessage(){
    	  var phone=$("#tel").val();
    	$.post("/ClientUser/onlyTel.do",{"tel":phone,"type":"trans"},function(data){
       	 if(data ==0){
  ...
  //timer处理函数  
    ...
    function checkEmail(){
    	 ...
    	 $.post("/ClientUser/onlyEmail.do",{"email":email,"type":"trans"},function(data){
    		 if(data ==0){
    ...
    <div class="container-fluid" style="padding:0;">
      ...
      <div class="register_top container">
        <div class="row">
          ...
          <h1 class="login_register col-sm-8"><spring:message  code='译员注册'/></h1>
        </div>
      </div>
      <!--------  login body  -------->
                  ...
                  <div class="login_form">
                    <%-- <div id="userMes" style="color:white;" class="cue"><spring:message  code='快速注册请注意格式'/></div> --%>
                      ...
                      <form name="loginform" id="login_form" class="loginForm form-horizontal" action="${pageContext.request.contextPath}/ClientUser/clientUserAction_saveUser.do"  method="post"><input type="hidden" name="did" value="0"/>
                       <input type="hidden" name='radioValue' id="radioValue" value="我是译员">
                       ...
                       <input type="hidden" name="radioValues" value="我是译员"/>

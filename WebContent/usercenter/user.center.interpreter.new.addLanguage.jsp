            ...
            <div class="my_customer_right col-sm-10">
              ...
              <div class="" >
                <ul id="suerTab" class="nav nav-tabs">
                  <li class="active"><a href="#basicdata" data-toggle="tab"><spring:message  code='申请翻译资格'></spring:message></a></li>
                </ul>
              </div>
                <!--  tab面板对应内容   -->
                <div class="myTabContent tab-content">
                	<a href="javascript:;" onmouseover="overShowTime()" onmouseout="outHideTime()" style="margin-left: 780px"><font color="red"><b><spring:message  code='查看帮助'/>?</b></font></a>
               		...
               		<div class="tab-pane fade in active" id="basicdata" style="background-color: #fff;height:1100px;;width:100%;margin-top:20px;">
               			<div style="height:100%;width:95%;float:left;">
               				<form action="<%=basePath%>/translator/addNewLanguage.do" method="post" enctype="multipart/form-data" onsubmit="return checkSubmit()">
	               				<div class="row" style="margin-top:0">
	               					<label class="rowlabel-left" style="font-size: 17px;color: #0000AA;"><spring:message  code='申请翻译资格'/></label>
	               				</div>
	               				<input type="hidden" name="id" id="transID" value="${translator.id }">
	               				<div class="row">
	               					<label class="col-xs-2 rowlabel-right"><font color="red">*</font><spring:message  code='选择语言：'/></label>
	               					<div class="col-xs-4">
	               						<select class='form-control' name="language" id="language" onchange="selectDoamins()">
	               							<option value=""><spring:message  code="请选择语言"/></option>
	               							<%-- <option value="英汉"><spring:message  code="英汉"/></option>
	               							<option value="汉英"><spring:message  code="汉英"/></option>
	               							<option value="韩汉"><spring:message  code="韩汉"/></option>
	               							<option value="汉韩"><spring:message  code="汉韩"/></option>
	               							<option value="日汉"><spring:message  code="日汉"/></option>
	               							<option value="汉日"><spring:message  code="汉日"/></option>
	               							<option value="法汉"><spring:message  code="法汉"/></option>
	               							<option value="汉法"><spring:message  code="汉法"/></option>
	               							<option value="德汉"><spring:message  code="德汉"/></option>
	               							<option value="汉德"><spring:message  code="汉德"/></option> --%>
	               							<c:forEach items="${languageList }" var="language">
	               								<option value="${language }"><spring:message  code="${language }"/></option>
	               							</c:forEach>
	               						</select>
	               					</div>
	               					<label class="col-xs-2 rowlabel-right"><font color="red">*</font><spring:message  code='选择领域：'/></label>
	               					<div class="col-xs-4">
	               				...
	               				<div class="row">
	               					...
	               					<div class="col-xs-2">
	               						<select class="form-control" name="transLevel" onchange="selectTransLevel()" id="transLevel" onmouseover="overShowLevel()" onmouseout="outHideLevel()">
	               					...
	               					<div class="col-xs-2">
	               						<select class="form-control" name="prooLevel" onchange="selectProoLevel()" id="prooLevel" onmouseover="overShowLevel2()" onmouseout="outHideLevel2()">
	               							<option value=""><spring:message  code="请选择"/></option>
	               							<option value="1">1</option>
	               							<option value="2">2</option>
	               							<option value="3">3</option>
	               					...
	               					<div class="col-xs-2">
	               						<select class="form-control" name="auditLevel" onchange="selectAuditLevel()" id="auditLevel" onmouseover="overShowLevel3()" onmouseout="outHideLevel3()">
	               							<option value=""><spring:message  code="请选择"/></option>
	               							<option value="1">1</option>
	               							<option value="2">2</option>
	               							<option value="3">3</option>
	               				...
	               				<div class="row">
	               					...
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" name="transWords" id="transWords" placeholder="<spring:message  code="万字"/>">
	               					</div>
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='校对总字数：'/></label>
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" name="prooWords" id="prooWords" placeholder="<spring:message  code="万字"/>">
	               					</div>
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='审核总字数：'/></label>
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" name="auditWords" id="auditWords" placeholder="<spring:message  code="万字"/>">
	               					</div>
	               				</div>
	               				...
	               				<div class="row">
	               					...
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" name="transWordsDay" id="transWordsDay" placeholder="<spring:message  code="字"/>">
	               					</div>
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='日校对字数：'/></label>
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" name="prooWordsDay" id="prooWordsDay" placeholder="<spring:message  code="字"/>">
	               					</div>
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='日审核字数：'/></label>
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" name="auditWordsDay" id="auditWordsDay" placeholder="<spring:message  code="字"/>">
	               					</div>
	               				</div>
	               				...
	               				<div class="row" style="margin-top: 0px;">
	               					...
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" style="color:red;" name="transPrice" id="transPrice" placeholder="<spring:message  code="元/千字"/>">
	               					</div>
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='翻译校对酬金：'/></label>
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" style="color:red;" name="prooPrice" id="prooPrice" placeholder="<spring:message  code="元/千字"/>">
	               					</div>
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='翻译校对审核酬金：'/></label>
	               					<div class="col-xs-2">
	               						<input class="form-control" type="text" disabled="disabled" style="color:red;" name="auditPrice" id="auditPrice" placeholder="<spring:message  code="元/千字"/>">
	               					</div>
	               				</div>
	               				...
	               				<div class="row">
	               					...
	               					<div class="col-xs-10">
	               						<textarea class="form-control" rows="5" name="orignalEssay" id="orignalEssay"></textarea>
	               					</div>
	               				</div>
	               				...
	               				<div class="row">
	               					...
	               					<div class="col-xs-10">
	               						<textarea class="form-control" rows="5" name="transEssay" id="transEssay"></textarea>
	               					</div>
	               				</div>
	               				...
	               				<%-- <div class="row">
	               					...
	               					<div class="checkbox col-xs-10">
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox1" name="checkbox[]" value="日常">
	               							<label for="checkbox1"><spring:message  code="日常"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox2" name="checkbox[]" value="机械">
	               							<label for="checkbox2"><spring:message  code="机械"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox3" name="checkbox[]" value="电子">
	               							<label for="checkbox3"><spring:message  code="电子"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox4" name="checkbox[]" value="电器">
	               							<label for="checkbox4"><spring:message  code="电器"/></label>
	               						</div>
	               					</div>
	               				</div>
	               				<div class="row" style="margin-top:0;">
	               					...
	               					<div class="checkbox col-xs-10">
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox5" name="checkbox[]" value="机电">
	               							<label for="checkbox5"><spring:message  code="机电"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox6" name="checkbox[]" value="自动化">
	               							<label for="checkbox6"><spring:message  code="自动化"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox7" name="checkbox[]" value="化学">
	               							<label for="checkbox7"><spring:message  code="化学"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox8" name="checkbox[]" value="通讯">
	               							<label for="checkbox8"><spring:message  code="通讯"/></label>
	               						</div>
	               					</div>
	               				</div>
	               				<div class="row" style="margin-top:0;">
	               					...
	               					<div class="checkbox col-xs-10">
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox9" name="checkbox[]" value="网络">
	               							<label for="checkbox9"><spring:message  code="网络"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox10" name="checkbox[]" value="物理">
	               							<label for="checkbox10"><spring:message  code="物理"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox11" name="checkbox[]" value="计算机">
	               							<label for="checkbox11"><spring:message  code="计算机"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox12" name="checkbox[]" value="化工">
	               							<label for="checkbox12"><spring:message  code="化工"/></label>
	               						</div>
	               					</div>
	               				</div>
	               				<div class="row" style="margin-top:0;">
	               					...
	               					<div class="checkbox col-xs-10">
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox13" name="checkbox[]" value="医药">
	               							<label for="checkbox13"><spring:message  code="医药"/></label>
	               						</div>
	               						<div class="col-xs-3">
	               							<input type="checkbox" id="checkbox14" name="checkbox[]" value="生化">
	               							<label for="checkbox14"><spring:message  code="生化"/></label>
	               						</div>
	               					</div>
	               				</div> --%>
	               				<div class="row">
	               					<label class="col-xs-2 rowlabel-right"><font color="red">*</font><spring:message  code='个人简历：'/></label>
	               					<div class="col-xs-4">
		               					<div class="money_file">
		               						<div class="money_file_block">
		               							<input id="file0" type="file" name="personalFile" lay-verify="picture" onchange="upfile(0)">
		                                  		<button class="btn btn-info"><spring:message  code='上传个人简历'/></button>
		               						</div>
		               					</div>
	               					</div>
	               					<label id="PF" class="col-xs-6 rowlabel-left" style="color:blue;"></label>
	               				</div>
	               				<div class="row">
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='翻译资料：'/></label>
	               					<div class="col-xs-4">
		               					<div class="money_file">
		               						<div class="money_file_block">
		               							<input id="file1" type="file" name="transFile" lay-verify="picture" onchange="upfile(1)">
		                                  		<button class="btn btn-info"><spring:message  code='上传翻译资料'/></button>
		               						</div>
		               					</div>
	               					</div>
	               					<label id="FY" class="col-xs-6 rowlabel-left" style="color:blue;"></label>
	               				</div>
	               				<div class="row">
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='校对资料：'/></label>
	               					<div class="col-xs-4">
		               					<div class="money_file">
		               						<div class="money_file_block">
		               							<input id="file2" type="file" name="proofFile" lay-verify="picture" onchange="upfile(2)">
		                                  		<button class="btn btn-info"><spring:message  code='上传校对资料'/></button>
		               						</div>
		               					</div>
	               					</div>
	               					<label id="JD" class="col-xs-6 rowlabel-left" style="color:blue;"></label>
	               				</div>
	               				<div class="row">
	               					<label class="col-xs-2 rowlabel-right"><spring:message  code='审核资料：'/></label>
	               					<div class="col-xs-4">
		               					<div class="money_file">
		               						<div class="money_file_block">
		               							<input id="file3" type="file" name="auditFile" lay-verify="picture" onchange="upfile(3)">
		                                  		<button class="btn btn-info"><spring:message  code='上传审核资料'/></button>
		               						</div>
		               					</div>
	               					</div>
	               					<label id="SH" class="col-xs-6 rowlabel-left" style="color:blue;"></label>
	               				</div>
	               				<div class="row">
									<div class="col-xs-12" style="text-align: right;">
										...
										<input class="btn btn-info" type="submit" style="margin-left:50px;" value="<spring:message  code='申请资格'/>">
									</div>               				
	               				</div>
               				</form>
               			</div>
